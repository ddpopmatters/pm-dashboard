 ...
 *
 * Props:
 * - frameworks: Array of testing frameworks
 * - selectedFrameworkId: ID of the currently selected framework
 * - selectedFramework: The selected framework object
 * - selectedFrameworkEntries: Entries linked to the selected framework
 * - frameworkEntryCounts: Object mapping framework IDs to linked entry counts
 * - onAddFramework: Callback to add a new framework
 * - onDeleteFramework: Callback to delete a framework
 * - onSelectFramework: Callback when selecting a framework
 * - onOpenEntry: Callback when opening an entry detail
 */
