...
export function ChevronLeftIcon({ className = iconBase, ...props }: IconProps): React.ReactElement {
  return (
    <SvgIcon className={className} {...props}>
      <path
...
export function SearchIcon({ className = iconBase, ...props }: IconProps): React.ReactElement {
  return (
    <SvgIcon className={className} {...props}>
...
export function BellIcon({ className = iconBase, ...props }: IconProps): React.ReactElement {
  return (
    <SvgIcon className={className} {...props}>
      <path
...
export function SettingsIcon({ className = iconBase, ...props }: IconProps): React.ReactElement {
  return (
    <SvgIcon className={className} {...props}>
