export const ASSET_TYPES = ['No asset', 'Video', 'Design', 'Carousel'];
...
export const CAMPAIGNS = ['Evergreen', 'Product launch', 'Event', 'Thought leadership', 'Advocacy'];
export const CONTENT_PILLARS = ['Awareness', 'Education', 'Engagement', 'Community', 'Conversion'];

export const ALL_PLATFORMS = ['Instagram', 'Facebook', 'LinkedIn', 'BlueSky', 'TikTok', 'YouTube'];
...
export const PLAN_TAB_FEATURES = {
  plan: 'calendar',
  trash: 'calendar',
  kanban: 'kanban',
  ideas: 'ideas',
...
export const PLAN_TAB_ORDER = ['plan', 'kanban', 'ideas', 'linkedin', 'testing', 'trash'];
