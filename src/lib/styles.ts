...
export const cardClasses = 'rounded-2xl border border-graystone-200 bg-white shadow-sm';

export const badgeClasses = 'inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium';
